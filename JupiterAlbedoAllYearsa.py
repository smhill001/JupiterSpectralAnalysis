...
#pl.plot(JupiterDSK_20130612UT[:,0]/10.,JupiterDSK_20130612UT[:,1]*0.60,label='DSK_20130612UT',linewidth=0.5)
#pl.plot(JupiterRNG_20130612UT[:,0]/10.,JupiterRNG_20130612UT[:,1]*0.60,label='RNG_20130612UT',linewidth=0.5)
pl.plot(TempSum[:,0]/10.,TempSum[:,1]*0.54,label='This Work (2014) 0.006m',linewidth=1)
...
pl.plot((Jupiter_1996UT[:,0]-7.)/10.,Jupiter_1996Smooth*0.55,label='Jupiter_1996UT-Smth',color='g',linewidth=1.0)

pl.plot(Jupiter_KarkRef1993[:,0]/10.,Jupiter_KarkRef1993[:,1],label='Karkoschka, 1994',linewidth=1,color='0.5')
